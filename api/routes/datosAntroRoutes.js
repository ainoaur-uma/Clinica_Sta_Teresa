...
router.get('/paciente/:NHC_paciente', datosAntroController.findByNHC); // Obtener todos los registros de un paciente por su NHC
router.patch('/:idDatoAntropometrico', datosAntroController.updateById); // Actualizar un registro de datos antropométricos por su ID (utilizando PATCH)
router.delete('/:idDatoAntropometrico', datosAntroController.deleteById); // Eliminar un registro de datos antropométricos por su ID
